...
h:\RAZVOJ\3D\utilities\combiner\Win32\Debug\Combine.exe twisty1-a.gcode twisty1-20.gcode 50 twisty1-15.gcode 60 twisty1-10.gcode 67 twisty1-7_5.gcode 75 twisty1-5.gcode
