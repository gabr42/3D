...
#define ARTIST_D_PRO_VERSION "Version:Artist-D Pro M2082 ImpV2021.9.13"
//===========================================================================
//============================= Getting Started =============================
//===========================================================================
...
#define MAX_REDUNDANT_TEMP_SENSOR_DIFF 10 //**IMP-Triggers M112 in DUPLICATION mode?
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 153.81
  #define DEFAULT_bedKi 23.12
  #define DEFAULT_bedKd 682.31
...
#define THERMAL_PROTECTION_CHAMBER // Enable thermal protection for the heated chamber //**IMP-Not in this build
#define THERMAL_PROTECTION_COOLER  // Enable thermal protection for the laser cooling  //**IMP-Not in this build
...
#define E0_DRIVER_TYPE TMC2209 // Gp: UART
#define E1_DRIVER_TYPE TMC2209 // Gp: UART
 ...
 */
#define DISTINCT_E_FACTORS //**IMP-Add E1 setting
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 20, 20 }
...
#define USE_PROBE_FOR_Z_HOMING // Gp
...
//#define DISABLE_INACTIVE_EXTRUDER   // Keep only the active extruder enabled **IMP - Disable for Duplication mode to work
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5 // **IMP-BLTouch // Gp: 5x5
 ...
 */
#define LCD_BED_LEVELING //**IMP-BLTouch
...
//
#define Z_SAFE_HOMING //**IMP-BLTouch
...
//
//#define TFT_GENERIC //**IMP-Try Display settings - works but can't confugure touchscreen
#if ENABLED(TFT_GENERIC)
  // :[ 'AUTO', 'ST7735', 'ST7789', 'ST7796', 'R61505', 'ILI9328', 'ILI9341', 'ILI9488' ]
  #define TFT_DRIVER AUTO

  // Interface. Enable one of the following options:
  #define TFT_INTERFACE_FSMC //**IMP-Try Display settings
  //#define TFT_INTERFACE_SPI

  // TFT Resolution. Enable one of the following options:
  //#define TFT_RES_320x240
  //#define TFT_RES_480x272
  #define TFT_RES_480x320 //**IMP-Display settings
#endif
