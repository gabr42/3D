...
#define CUSTOM_MACHINE_NAME "Pangolin"
...
#define HOTEND_OFFSET_Y { 0.0, 0.30 }  // (mm) relative Y-offset for each nozzle // Gp: Hemera
#define HOTEND_OFFSET_Z { 0.0, 0.0 }  // (mm) relative Z-offset for each nozzle // Gp: Hemera
 ...
 *
 */
#define TEMP_SENSOR_0 5   // Gp: Hemera
#define TEMP_SENSOR_1 5   // Gp: Hemera
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  21.30,  21.30 }
    #define DEFAULT_Ki_LIST {   1.51,   1.51 }
    #define DEFAULT_Kd_LIST {  75.15,  75.15 }
  #else
...
#define Z_MIN_ENDSTOP_INVERTING true  // Set to true to invert the logic of the endstop.  //Change to False for BLtouch
#define I_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define J_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define K_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define X_MAX_ENDSTOP_INVERTING true  // Set to true to invert the logic of the endstop.  //TwinkieXLII
#define Y_MAX_ENDSTOP_INVERTING true  // Set to true to invert the logic of the endstop.  //TwinkieXLII
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 395, 395 } //**IMP-Add E1 setting for DISTINCT_E_FACTORS // Gp: Hemera
...
#define USE_PROBE_FOR_Z_HOMING //ENABLE for BLTOUCH TwinkieXLII
 ...
 */
#define MULTIPLE_PROBING 2 //TwinkieXLII enable for bltouch
...
//#define DISABLE_INACTIVE_EXTRUDER   // Keep only the active extruder enabled TWINKIXLII not needed >2093
...
#define INVERT_E0_DIR true // Gp: Hemera
...
#define FILAMENT_RUNOUT_SENSOR   //TwinkieXLII
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 100  //TwinkieXLII
...
#define ENABLE_LEVELING_AFTER_G28    //Twinkie 2022.1 Changed from RESTORE
...
#define LEVEL_BED_CORNERS  //TwinkieXLII 
  ...
  #define LEVEL_CENTER_TOO                // Move to the center after the last corner  //TwinkieXLII centerpost
 ...
 */
#define Z_SAFE_HOMING  //TwinkieXLII... Bltouch
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 99.46
  #define XY_DIAG_BD 100.0267
  #define XY_SIDE_AD 70.5427
...
#define NOZZLE_PARK_FEATURE    //TwinkieXLII
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 3), (Y_MAX_POS - 3), 10 } //TwinkieXLII try not to park in brush
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { { -40, 30, (Z_MIN_POS + 1) }, { 339, 30, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { -25, 30, (Z_MIN_POS + 1) }, { 354, 30, (Z_MIN_POS + 1) } }
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //TWINKIEXLII
