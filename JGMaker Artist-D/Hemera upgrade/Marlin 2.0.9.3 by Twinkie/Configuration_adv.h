...
#define DUAL_X_CARRIAGE
  ...
  #define X1_MAX_POS X_BED_SIZE-3  // Set a maximum so the first X-carriage can't hit the parked second X-carriage
  #define X2_MIN_POS    3          // Set a minimum to ensure the  second X-carriage can't hit the parked first X-carriage  /JGMaker 5mm
  #define X2_MAX_POS   374.55      // Set this to the distance between toolheads when both heads are homed  手工测 284   增加上层向左偏移，减小向右  新机实测两喷头间距离为435mm
  ...
  #define DEFAULT_DUPLICATION_X_OFFSET 155 //TwinkieXLII
...
#define QUICK_HOME                          // If G28 contains XY do a diagonal move first //TwinkieXLII sincd 2021
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #if HAS_BED_PROBE
    #define PROBE_OFFSET_WIZARD //**IMP-BLTouch
...
// LCD Print Progress options
  ...
  #define EVENT_GCODE_SD_ABORT "G28X\nM84 X Y E"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27") TwinkieXLII
  ...
  //#define BINARY_FILE_TRANSFER //TwinkieXLII TOOD investigate
...
#define ADVANCED_PAUSE_FEATURE //TwinkieXLII
  ...
  //#define FILAMENT_CHANGE_RESUME_ON_INSERT      // TODO Automatically continue / load filament when runout sensor is triggered again.
  //#define PAUSE_REHEAT_FAST_RESUME              // TODO Reduce number of waits by not prompting again post-timeout before continuing.
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       850        // (mA) RMS current. Multiply by 1.414 for peak current. // Gp: UART
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      900 // Gp: Hemera
    #define E0_MICROSTEPS    16
  ...
  #if AXIS_IS_TMC(E1)
    #define E1_CURRENT      900 // Gp: Hemera
    #define E1_MICROSTEPS   E0_MICROSTEPS
  ...
  #if AXIS_IS_TMC(E2)
    #define E2_CURRENT      900 // Gp : just in case ;)
    #define E2_MICROSTEPS   E0_MICROSTEPS
...
#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others). //TwinkieXLII 2022.0
 ...
 */
#define HOST_ACTION_COMMANDS       //TwinkieXLII since 2021.0
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76           //TwinkieXLII since 2022.1
  #define HOST_PROMPT_SUPPORT      //TwinkieXLII since 2021.0
 ...
 */
#define CANCEL_OBJECTS			//TwinkieXLII sincd 2022.1
