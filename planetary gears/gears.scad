...
module planetary_gear(modul, sun_teeth, planet_teeth, number_planets, width, rim_width, bore, pressure_angle=20, helix_angle=0, together_built=true, optimized=true,scaling=1){
    ...
    echo("Ring teeth = ", ring_teeth);
    echo("(R+S)/P = ", (ring_teeth + sun_teeth) / planet_teeth);
